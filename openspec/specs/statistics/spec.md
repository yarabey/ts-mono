...
## Purpose
Compute aggregated baby-development statistics over selectable periods, including feeding/sleep/diaper/pumping/walk aggregates, age-aware wake windows, milk balance, daily pattern timelines, and growth charts with WHO percentiles. All aggregation results validate against the shared Zod contracts.
