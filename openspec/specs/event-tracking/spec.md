...
## Purpose
Store and manage baby events as a typed event log, with CRUD, listing/filtering, quick actions, open/close lifecycle with timers, and photo attachments. All events validate against the shared Zod contracts in `@acme/baby-bot-domain`.
